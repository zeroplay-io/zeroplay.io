...
Запустіть гру і натисніть кнопку *Settings* у верхньому правому куті.
...
### Крок 3: Підтвердіть свою дію

Введіть код підтвердження, який відображається на екрані, а потім натисніть кнопку *Delete*, щоб продовжити.
...
- **Постійна дія** — Всі ваші ігрові дані будуть видалені назавжди
- **Без відновлення** — Цю дію не можна скасувати після закінчення зворотного відліку
