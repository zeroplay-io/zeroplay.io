...
Spusťte hru a klepněte na tlačítko *Settings* v pravém horním rohu.
...
### Krok 3: Ověřte svou akci

Zadejte potvrzovací kód zobrazený na obrazovce a poté klepněte na tlačítko *Delete* pro pokračování.
...
- **Trvalá akce** — Všechna vaše herní data budou trvale smazána
- **Bez obnovení** — Tuto akci nelze vrátit zpět po skončení odpočítávání
