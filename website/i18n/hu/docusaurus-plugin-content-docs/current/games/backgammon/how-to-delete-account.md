...
Indítsa el a játékot, és koppintson a *Settings* gombra a jobb felső sarokban.
...
### 3. lépés: Hitelesítse Műveletét

Írja be a képernyőn megjelenő megerősítő kódot, majd koppintson a *Delete* gombra a folytatáshoz.
...
- **Végleges Művelet** — Minden játékadata véglegesen törlődik
- **Nincs Visszaállítás** — Ez a művelet nem vonható vissza a visszaszámlálás lejárta után
