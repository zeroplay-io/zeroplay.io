...
**IMPORTANTE: AS APLICAÇÕES LICENCIADAS DISPONÍVEIS ATRAVÉS DAS LOJAS DE APLICAÇÕES SÃO LICENCIADAS, NÃO VENDIDAS, A VOCÊ.** A sua licença para cada Aplicação Licenciada está sujeita à sua aceitação prévia destes Termos. Reservamos todos os direitos nas e para as Aplicações Licenciadas não expressamente concedidos a você sob estes Termos.

## 2. Registro de Conta e Elegibilidade

2.1. Você pode precisar criar uma conta para usar certos recursos de nossos Serviços. Você pode criar uma conta diretamente ou através de plataformas de terceiros.

2.2. Você declara que qualquer informação fornecida durante o registro é precisa e completa.

2.3. Os requisitos de idade podem variar dependendo do jogo específico. Você deve cumprir as restrições de idade especificadas para cada jogo.
...
3.1. **Concessão de Licença.** Concedemos a você uma licença não transferível, não exclusiva e revogável para usar as Aplicações Licenciadas em dispositivos que você possui ou controla e conforme permitido pelas regras de uso das lojas de aplicações aplicáveis.

3.2. **Âmbito da Licença.** Os termos deste Acordo regerão qualquer conteúdo, material ou serviço acessível de ou comprado dentro da Aplicação Licenciada, bem como atualizações que fornecemos que substituem ou complementam a Aplicação Licenciada original, a menos que tal atualização seja acompanhada de termos separados.
...
5.1. Algumas das nossas aplicações podem oferecer serviços de assinatura com renovação automática ("Assinaturas"). Quando optar por adquirir uma Assinatura em qualquer uma das nossas aplicações, o nome específico da assinatura, duração e preço serão claramente apresentados na aplicação antes de confirmar a compra.

5.2. O pagamento será cobrado na sua conta Apple ID no momento da confirmação da compra.

5.3. As Assinaturas renovam-se automaticamente, a menos que a renovação automática seja desativada pelo menos 24 horas antes do final do período atual.

5.4. A sua conta será cobrada pela renovação dentro de 24 horas antes do final do período atual.

5.5. Pode gerir e cancelar a sua Assinatura a qualquer momento, acedendo às definições da sua conta na App Store após a compra.

5.6. Qualquer parte não utilizada de um período de avaliação gratuita (se oferecido) será perdida quando adquirir uma Assinatura.
...
6.2. Podemos usar essas informações, desde que estejam numa forma que não o identifique pessoalmente, para melhorar nossos produtos ou para fornecer serviços ou tecnologias a você.

6.3. Consulte a nossa [Política de Privacidade](/docs/legal/privacy-policy) para informações detalhadas sobre como coletamos, usamos e protegemos os seus dados pessoais.

## 7. Conduta do Utilizador
...
10.1. Este Acordo é efetivo até ser rescindido por você ou por nós. Os seus direitos sob este Acordo terminarão automaticamente se você não cumprir qualquer um dos seus termos.
...
**EM NENHUMA CIRCUNSTÂNCIA A NOSSA RESPONSABILIDADE TOTAL PARA COM VOCÊ POR TODOS OS DANOS (EXCETO CONFORME POSSA SER EXIGIDO PELA LEI APLICÁVEL EM CASOS ENVOLVENDO LESÕES PESSOAIS) EXCEDERÁ O MONTANTE DE CINQUENTA DÓLARES ($50,00). AS LIMITAÇÕES ACIMA APLICAR-SE-ÃO MESMO QUE O REMÉDIO ACIMA DECLARADO NÃO CUMPRA O SEU PROPÓSITO ESSENCIAL.**
...
14.2. De acordo com 48 C.F.R. §12.212 ou 48 C.F.R. §227.7202-1 a 227.7202-4, conforme aplicável, o Software de Computador Comercial e a Documentação de Software de Computador Comercial estão sendo licenciados aos utilizadores finais do Governo dos EUA (a) apenas como Itens Comerciais e (b) apenas com aqueles direitos concedidos a todos os outros utilizadores finais de acordo com os termos e condições aqui contidos.

14.3. Os direitos não publicados estão reservados sob as leis de direitos de autor dos Estados Unidos.
...
17.3. **Renúncia.** A nossa falha em fazer cumprir qualquer direito ou disposição destes Termos não será considerada uma renúncia a esses direitos.

17.4. **Cessão.** Você não pode ceder ou transferir estes Termos sem o nosso consentimento prévio por escrito. Podemos ceder os nossos direitos e obrigações sob estes Termos sem restrição.

## 18. Entre em Contacto

Para perguntas sobre estes Termos de Serviço, entre em contacto connosco em: [support@zeroplay.io](mailto:support@zeroplay.io).

Consulte também a nossa [Política de Privacidade](/docs/legal/privacy-policy) para informações sobre como coletamos, usamos e protegemos os seus dados pessoais.
