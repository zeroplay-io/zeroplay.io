...
2.1. Saatat joutua luomaan tilin käyttääksesi tiettyjä Palveluidemme ominaisuuksia. Voit luoda tilin suoraan tai kolmannen osapuolen alustojen kautta.

2.2. Vakuutat, että kaikki rekisteröinnin yhteydessä antamasi tiedot ovat tarkkoja ja täydellisiä.

2.3. Ikävaatimukset voivat vaihdella pelin mukaan. Sinun on noudatettava kullekin pelille määriteltyjä ikärajoituksia.
