...
### Trinn 1: Få Tilgang til Din Profil

Trykk på *Me* fanen på nedre navigasjonslinje for å få tilgang til profilsiden din.
...
- **Permanent Handling** — Alle spilldataene dine vil bli permanent slettet
- **Ingen Gjenoppretting** — Denne handlingen kan ikke angres etter at nedtellingen er over
