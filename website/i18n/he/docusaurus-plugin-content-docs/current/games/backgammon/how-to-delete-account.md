...
הפעל את המשחק והקש על כפתור *Settings* בפינה הימנית העליונה.
...
### שלב 3: אמת את הפעולה שלך

הקלד את קוד האישור המוצג על המסך, ולאחר מכן הקש על כפתור *Delete* כדי להמשיך.
