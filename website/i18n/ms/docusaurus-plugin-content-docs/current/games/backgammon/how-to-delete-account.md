...
### Langkah 1: Buka Tetapan

Lancarkan permainan dan ketik butang *Settings* di penjuru kanan atas.
...
### Langkah 3: Sahkan Tindakan Anda

Taip kod pengesahan yang dipaparkan pada skrin, kemudian ketik butang *Delete* untuk meneruskan.
...
- **Tindakan Kekal** — Semua data permainan anda akan dipadamkan secara kekal
- **Tiada Pemulihan** — Tindakan ini tidak boleh dibatalkan selepas kiraan detik tamat
