...
export default function RubikPage(): JSX.Element {
  const { i18n } = useDocusaurusContext();
  const baseGame = gamesData.games.find((g) => g.id === "rubik");
  const localizedGame = getLocalizedGame("rubik", i18n.currentLocale);
